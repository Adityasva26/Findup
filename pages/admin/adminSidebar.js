...
function Sidebar() {
    ...
    <div className="list-group list-group-flush">
        ...
        <Link className={window.location.pathname=="/admin/deal"?"list-group-item list-group-item-action list-group-item-light p-3 active":"list-group-item list-group-item-action list-group-item-light p-3"}href="/admin/deal">Deal</Link>
